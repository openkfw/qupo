...
class PortfoliosModel():
    ...
    def __post_init__(self, stocks, risk_free_return_pa):
        ...
        for stock in stocks:
            ...
            stocks_expected_rate_of_return_pa = np.concatenate((stocks_expected_rate_of_return_pa,
                                                                fu.calc_historic_rate_of_return_pa(stocks_time_series[stock.ticker])))
        ...
        expected_sharpe_ratios = fu.calc_historic_sharpe_ratio(np.array(self.expected_rates_of_return_pa[1:]),
                                                               risk_free_return_pa, np.array(self.expected_volatilities_pa[1:]))
