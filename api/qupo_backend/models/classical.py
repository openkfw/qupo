...
def calculate_classical(db, model, symbols, risk_weight=0.0001, esg_weight=0.0001):
    ...
    P, q, A, l, u = fu.convert_business_to_osqp_model(portfolio_model_df, risk_weight, esg_weight)
    ...
    solver_osqp = obr.Solver(provider_name='University of Oxford', algorithm=model)
