...
Help()
{
    ...
    echo "Example: $(basename "$0") --project api -in kfwopensource/qupo-api"
    echo "options:"
    echo "-p  | --project           The project folder name"
    echo "-in | --image-name        The name of the docker image which shall be pushed (e.g. kfwopensource/qupo-api)"
